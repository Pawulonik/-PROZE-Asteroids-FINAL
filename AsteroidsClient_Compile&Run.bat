...
jar cvfm Asteroids.jar src\\META-INF\\MANIFEST.MF src\\Asteroid.java src\\AsteroidsGame.java src\\Bonus.java src\\Client.java src\\GamePane.java src\\HowToPlayWindow.java src\\GameWindow.java src\\main.java src\\MainMenu.java src\\OptionsWindow.java src\\ScoresWindow.java src\\Ship.java src\\Shot.java
PAUSE 
ECHO. 
